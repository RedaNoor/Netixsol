...
@tool
def player_season_stats(player_name: str, year: int, team: str = None, include_finals: bool = False) -> dict:
...
@tool
def player_finals_stats(player_name: str, year: int, team: str = None) -> dict:
...
@tool
def player_recent_games(player_name: str, n: int = 1, team: str = None) -> dict:
...
@tool
def player_career_stats(player_name: str, team: str = None) -> dict:
...
@tool
def player_bio(player_name: str, team: str = None) -> dict:
...
@tool
def match_score_breakdown(team_a: str, team_b: str, year: int = None, round: str = None) -> dict:
...
@tool
def season_leaderboard(year: int, stat: str = "fantasy_points", team: str = None,
...
@tool
def team_roster(team: str, year: int = None) -> dict:
